...
public class Strings {
     ...
     * ストーリー
     */
    public final static String STORY = "主人公は激怒した。必ず、かの邪智暴虐の魔王を除かなければならぬと決意した。\n" +
            "主人公には政治がわからぬ。けれども邪悪に対しては、人一倍に敏感であった。\n" +
            "「呆れた魔王だ。生かして置けぬ。」\n" +
            ...
            "竹馬の友は王城に召された。主人公は、友に一切の事情を語った。友は無言で首肯き、主人公をひしと抱きしめた。\n" +
            "友と友の間は、それでよかった。主人公は、すぐに出発した。初夏、満天の星である。\n";
    /**
     * ゲームルール
     */
    public final static String RULE = "ルール\n" +
            ...
            "　※ステータスはレベル1の時のものです\n" +
            "ヒント\n" +
            "　マップアイコン　P：主人公,　S：織田信長(ボス),　A：レベル3の敵,　B：レベル2の敵,　C：レベル1の敵\n" +
    ...
    public static final String GAME_OVER_CLEAR = "\n「待て。その人を殺してはならぬ。主人公が帰って来た。\n" +
            "約束のとおり、いま、帰って来た。殺されるのは、私だ。彼を人質にした私は、ここにいる！」\n" +
